...
function selectUrgentEdit(urgentID, mediumID, lowID) {
    ...
    document.getElementById('prio-urgent-c-t-edit-img').src = "./assets/img/arrows_up_w.svg";
    document.getElementById('prio-medium-c-t-edit-img').src = "./assets/img/equal-sign.svg";
    document.getElementById('prio-low-c-t-edit-img').src = "./assets/img/arrows-down.svg";
...
function selectMediumEdit(urgentID, mediumID, lowID) {
    ...
    document.getElementById('prio-medium-c-t-edit-img').src = "./assets/img/equal_sign_w.svg";
    document.getElementById('prio-urgent-c-t-edit-img').src = "./assets/img/arrows-up.svg"; // urgent setzt zurÃ¼ck
    document.getElementById('prio-low-c-t-edit-img').src = "./assets/img/arrows-down.svg"; // low setzt zurÃ¼ck
...
function selectLowEdit(urgentID, mediumID, lowID) {
    ...
    document.getElementById('prio-low-c-t-edit-img').src = "./assets/img/arrows_down_w.svg";
    document.getElementById('prio-urgent-c-t-edit-img').src = "./assets/img/arrows-up.svg"; // urgent setzt zurÃ¼ck
    document.getElementById('prio-medium-c-t-edit-img').src = "./assets/img/equal-sign.svg";
