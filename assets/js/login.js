...
function checkLocalstorage() {
    if (localStorage.getItem('rememberMEChecked')) {
...
function getInfosFromLocalstorage() {
    ...
    rememberMe.checked = localStorage.getItem('rememberMEChecked');
}
...
function logIn() {
    ...
    if (loggedUser) {
        setInfosToLocalstorage(loggedUser);
...
function setInfosToLocalstorage(loggedUser) {
    localStorage.setItem("loggedUser", JSON.stringify(loggedUser));
    let rememberMe = document.getElementById('remember-me');
    if (rememberMe.checked) {
        localStorage.setItem('rememberMEChecked', rememberMe.checked);
