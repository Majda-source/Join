...
function activeBg(id) {
    ...
    if (id == 'prio-urgent') {
        activeBgUrgent(urgent, medium, low);
    }
    if (id == 'prio-medium') {
        activeBgMedium(urgent, medium, low);
    }
    if (id == 'prio-low') {
        activeBgLow(urgent, medium, low);
    }
}
 ...
 */
function activeBgUrgent(urgent, medium, low) {
    document.getElementById('urgent-img').src = "./assets/img/arrows_up_w.svg";
    document.getElementById('medium-img').src = "./assets/img/equal-sign.svg";
    document.getElementById('low-img').src = "./assets/img/arrows_down_w.svg";
 ...
 * @param {*} low -stands for not so important
 */
function activeBgMedium(urgent, medium, low) {
    document.getElementById('urgent-img').src = "./assets/img/arrows-up.svg";
    document.getElementById('medium-img').src = "./assets/img/equal_sign_w.svg";
    document.getElementById('low-img').src = "./assets/img/arrows-down.svg";
 ...
 * @param {*} low -stands for not so important
 */
function activeBgLow(urgent, medium, low) {
    document.getElementById('urgent-img').src = "./assets/img/arrows-up.svg";
    document.getElementById('medium-img').src = "./assets/img/equal-sign.svg";
    document.getElementById('low-img').src = "./assets/img/arrows_down_w.svg";
    urgent.classList.remove('bg-orange');
...
function showXandCheckmark() {
    if (twoSubtaskIcons == false) {
        ...
        <img onclick="closeSubtask()" id="close-icon" src="./assets/img/close.svg" alt="close">
        <img onclick="addSubtask()" id="checkmark-icon" src="./assets/img/create.png" alt="checkmark">`;
...
function closeSubtask() {
    ...
    document.getElementById('subtask-icons').innerHTML = /*html*/ `
    <img id="plus-icon" src="./assets/img/plus.png" alt="plus">`;
    twoSubtaskIcons = true;
}
