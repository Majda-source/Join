...
function abcHTML(letter) {
    ...
    <button onclick="newConatct()" class="new-contact-responsiv">
                ...
                <img src="./assets/img/add_user.svg">
            </button>
...
function memberInfoHtml(i, letters) {
    ...
    <div class="member">
                    ...
                    <div>
                        ...
                        <a href="add_task.html" class="email"><img class="plus" src="./assets/img/plus_blue.svg">Add Task</a>
                    </div>
                </div>

                <div class="contact-info-edit">
                    <div class="fontsice-21">Contact Information</div>
                    <div onclick="editContact(${i})" class="edit-contact-pencil"><img src="./assets/img/pencil.svg"> Edit Contact</div>
                </div>
                <div onclick="editContact(${i})" class="edit-contact-icon"><img class="edit-contact-icon-img" src="./assets/img/pencil.svg"></div>
                <div>
                    <b>Email</b>
                    <div class="email">${contact[i]['email']}</div>
                </div>
