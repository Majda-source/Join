...
function activeMenuBg() {
    ...
    else if (location.pathname == "/legal_notice.html") {
        document.getElementById('legal-notice').style = 'background: #091931; !important';
    }

    else if (location.pathname == "/privacy.html") {
