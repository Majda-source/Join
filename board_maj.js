...
function switchAddIcon(id) {
    document.getElementById(id).src = "./assets/img/plus_blue.svg";
}
...
myMediaQuery1400.addListener(checkResponsive); // addListener prÃ¼ft bei Ã¤nderung der BildschirmgrÃ¶ÃŸe ob mediaQuerry noch zutrifft oder nicht
 ...
 * 
 */
function deleteSearchFieldHTML(id2) {
